...
```shell
$ docker run --rm -it --network host kevinwan/tproxy:v1 tproxy -l 0.0.0.0 -p <listen-port> -r <remote-port>
```

arm64 系统:

```shell
$ docker run --rm -it --network host kevinwan/tproxy:v1-arm64 tproxy -l 0.0.0.0 -p <listen-port> -r <remote-port>
```
